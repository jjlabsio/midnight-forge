...
The root AI owns model selection for quality-critical work. It uses the
GPT-5.6 family and subjectively weighs task difficulty, risk, ambiguity,
novelty, consequence, chart context, expected quality, and cost. The policy
defines boundaries and guardrails, not a scoring formula,
benchmark-equivalence gate, or fixed task-to-model table.
