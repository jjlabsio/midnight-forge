...
- Existing full replacements remain supported only with explicit rationale and validation.

## Open Questions

- How far overlay v2 should migrate beyond artifact-storage-only skills.
