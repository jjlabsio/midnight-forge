...
judgment is flexible enough for routing, authority, review, downstream impact,
...
- Model-led MDF skills for task interpretation, canonical state decisions,
  authority evidence, workflow routing, review, simplification, ship, GitHub handoff,
...
| Spec/plan/build/review/ship lifecycle gates | Removed from scripts; preserved as Markdown authority evidence and handoffs | Model + upstream skills |
