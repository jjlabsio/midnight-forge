...
6. Perform a task-level review against the plan acceptance criteria
7. Fix blocking findings, then rerun the relevant verification and task-level review
...
3. Review the whole change against the spec and plan
