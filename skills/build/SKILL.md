...
2. Run exact upstream `using-agent-skills` discovery. Load this adapter,
   `incremental-implementation`, `test-driven-development`, and every other
   applicable primitive it selects.
3. Bind upstream spec lookup to the exact approved canonical
   `.mdf/work/<work-id>/spec-NNN.md`, and bind `tasks/plan.md` plus
