...
When explicitly authorized subagent tools are available, the role-based reviewer prompts in `agents/` can be used for isolated review — see `agents/` for the roster and per-domain match.
